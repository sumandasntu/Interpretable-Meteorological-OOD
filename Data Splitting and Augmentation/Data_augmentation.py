...
if __name__ == '__main__':
    ...
    parser.add_argument('--percentage', default=25, type=int, help='Input folder name only ')
    args = parser.parse_args()
    
path=args.path
p=25                 ###percentage of label data
### BIG Kernel 22*11
...
def process_folder(folder: str, rain_level: float,  output_d: Tuple[int]) -> None:
    ...
    rain_level_mod=rain_level_mod=[0, .27, .55,  .9, 1.3, 1.7, 2.3, 3, 4, 5.75, 15]# three drops
