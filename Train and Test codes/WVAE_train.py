...
if __name__ == '__main__':
    ...
    parser.add_argument('--weight', default='weights', type=str, help='provide a name for the weight file')
...
for epoch in range(num_epochs):
    ...
    torch.save({'epoch': epoch, 'model_state_dict': vae.state_dict(), 'optimizer_state_dict': optimizer.state_dict(),'loss': loss,}, f"{args.weight}.pt")
